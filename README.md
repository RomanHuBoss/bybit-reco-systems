...
## Что делает система
- собирает только `linear` тикеры и OHLCV по USDT perpetual символам; public Bybit client отклоняет нецелевой category/symbol до сетевого запроса и фильтрует exact-symbol responses;
