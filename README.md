...
- targeted audit regression: `8 passed, 1 warning` (`iteration105`, selected `iteration107`, new `iteration114`);
- AST parse: `main.py + app/*.py + tests/test_iteration114*.py` — passed;
- full-suite attempt in this container was interrupted by environment/tooling timeout before completion; previous release baseline before these 2 added tests was `342 passed`, so expected release baseline is at least `344 passed` in the normal dev environment;
