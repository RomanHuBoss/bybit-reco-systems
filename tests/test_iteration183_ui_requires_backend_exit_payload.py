...
def test_linear_directional_ui_blocks_local_tp_sl_when_backend_exit_payload_missing() -> None:
...
console.log(JSON.stringify({tp: result.takeProfitValue, sl: result.stopLossValue, label: result.takeProfitLabel}));
"""
    out = _run_js(code)
