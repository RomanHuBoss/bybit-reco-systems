...
def test_calibration_identity_changes_when_shadow_sampling_contract_changes() -> None:
    assert RECOMMENDER_MODEL_VERSION == "bybit-taxonomy-v8-policy-conditioned-censor-aware"
    assert BOT_CALIB_KEYS["futures_grid"] == "logreg_futures_grid_v19"
    assert GLOBAL_LOGREG_KEY == "logreg_global_v19"
