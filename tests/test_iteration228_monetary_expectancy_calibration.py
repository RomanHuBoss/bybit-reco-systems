...
def test_positive_monetary_expectancy_remains_calibratable() -> None:
...
def test_fresh_negative_expectancy_cache_is_loaded_despite_unfitted_model(tmp_path, monkeypatch) -> None:
    ...
    key = calibration.BOT_CALIB_KEYS["futures_grid"]
    ...
    loaded = recommender._load_or_fit_bot_logregs(conn, min_samples=80)
