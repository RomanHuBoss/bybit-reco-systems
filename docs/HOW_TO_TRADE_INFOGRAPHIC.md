## v1.0.70 — как читать рост исходов при нулевой калибровке

`Исходы всего` и `данные текущего набора правил` — разные показатели. Риск-чистые строки `НЕ ТОРГОВАТЬ` могут получить исследовательский proxy-outcome для проверки гипотезы. Если причина включает непрохождение candidate screen, такой outcome не обучает текущий calibrator и не разрешает сделку. Не снижайте пороги вручную ради ускорения накопления `calibrator_n`.
